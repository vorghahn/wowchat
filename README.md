...
## Run
1. Download the latest ready-made binary from github releases: https://github.com/vorghahn/wowchat/releases
...
3. Run `mvn clean package` which will produce a file in the target folder called `wowchat-2.1.0.zip`
4. unzip `wowchat-2.1.0.zip`, edit the configuration file and run `java -jar wowchat.jar <config file>`
